						...
						<div class="col-md-6">
							...
							<div class="card card-info mt-5">
								...
								<form action="<?php echo base_url(); ?>category/updateCategoriesForm"
									...
									<input type="hidden"  name="cid" value="<?php echo $categoriesByID->cid;?>">
									<div class="card-body">
										<div class="form-group row ">
											<label for="inputEmail3" class="col-sm-2 col-form-label">Category
												Name</label>
											<div class="col-sm-8">
												<input type="text"  name="name" value="<?php echo $categoriesByID->name ;?>" class="form-control" id="inputEmail3"
